        ...
        <div class="col-md-10 p-4">
            ...
            <div class="row g-3 mb-4">
                <div class="col-6 col-md-4">
                    <div class="stat-card" style="background:var(--kj-green)">
                        ...
                        <div class="stat-label"><i class="bi bi-send me-1"></i>Demandes envoyées</div>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="stat-card" style="background:#2980b9">
                        <div class="stat-number">{{ $stats['favorites'] }}</div>
                        <div class="stat-label"><i class="bi bi-heart me-1"></i>Professeurs favoris</div>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="stat-card" style="background:#8e44ad">
                        <div class="stat-number">{{ $stats['messages'] }}</div>
                        <div class="stat-label"><i class="bi bi-chat me-1"></i>Messages non lus</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('parent.requests') }}" class="btn btn-sm btn-outline-secondary">Voir tout</a>
                </div>
                <div class="card-body p-0">
                    @if($recentRequests->isEmpty())
                        <div class="text-center py-5 text-muted">
                            ...
                            <br>
                            <a href="{{ route('search.index') }}" style="color:var(--kj-green)">Trouvez un professeur</a>
                        </div>
                    @else
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                @endif
                                                <span class="fw-semibold small">{{ $req->teacher->user->name }}</span>
                                            </div>
                                        </td>
