        ...
        <div class="col-md-10 p-4">
            ...
            @if($favorites->isEmpty())
                <div class="card text-center py-5">
                    ...
                    <p class="text-muted small">Ajoutez des professeurs à vos favoris pour les retrouver facilement.</p>
                    <div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card teacher-card h-100 p-3">
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    @if($teacher->photo)
                                        <img src="{{ asset('storage/'.$teacher->photo) }}" class="teacher-avatar">
                                    @else
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-muted">{{ $teacher->experience_years }} an(s) d'expérience</div>
                                    </div>
                                </div>
                                <div class="mb-2">
                                ...
                                @if($teacher->zones->first())
                                    <div class="small text-muted mb-2">
                                        <i class="bi bi-geo-alt me-1"></i>{{ $teacher->zones->first()->city }}
                                    </div>
                                @endif
                                ...
                                <div class="d-flex gap-2 mt-auto">
                                    <a href="{{ route('teacher.public', $teacher->id) }}" class="btn btn-sm btn-kj flex-fill">
                                        Voir le profil
                                    </a>
                                    <form action="{{ route('parent.favorites.toggle', $teacher->id) }}" method="POST">
                                        @csrf
