        ...
        <div class="col-md-10 p-4">
            ...
            @if($requests->isEmpty())
                <div class="card text-center py-5">
                    ...
                    <div>
                        <a href="{{ route('teacher.profile') }}" class="btn btn-kj px-4">
                    ...
                    @foreach($requests as $req)
                        <div class="col-md-6">
                            <div class="card p-3">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div>
                                        ...
                                        <div class="small text-muted">
                                            {{ $req->created_at->format('d/m/Y à H:i') }}
                                        </div>
                                    </div>
                                    @php
                                        $badges = [
                                ...
                                @if($req->message)
                                    <p class="small bg-light rounded p-2 mb-2">
                                        {{ $req->message }}
                                    </p>
                                @endif
                                ...
                                @if($req->status === 'sent')
                                    <div class="d-flex gap-2 mt-2">
                                        <form action="{{ route('teacher.requests.update', $req->id) }}"
                                              method="POST">
                                            @csrf @method('PATCH')
